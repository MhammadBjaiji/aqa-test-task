...
test.describe("Task Assignment Workflow", () => {
  ...
  test.beforeAll(async ({ browser }) => {
    ...
    // 6. Share project with team (add team to project with Read & Write permission)
  ...
  test("@critical @integration @slow @tasks should assign task to another user and verify in both API and UI", async ({
    page,
  }) => {
